...
<html>
    <head>
        ...
        <link type = "text/css" rel = "stylesheet" href = "/common/styles/styles.css"/>
        ...
        <form class="row row-cols-lg-auto g-3 align-items-center" action = "signup-submit.php" method = "POST">
            <div class="mb-3 w-25 centered">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" size = "16" class="form-control" name = "firstName">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Last Name</span>
                    <input type="text" size = "16" class="form-control" name = "lastName">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Email Address</span>
                    <input type="text" size = "16" class="form-control" name = "email">
                </div>
                <div class="input-group mb-3">
